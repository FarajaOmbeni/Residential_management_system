...
public class announcements extends Application {
    ...
    public void start(Stage announcementsStage) {
           ...
           Label anct_lbl = new Label("Announcement");
           TextField title_txt = new TextField();
           PasswordField anct_txt = new PasswordField();
           ...
           gridPane.add(anct_txt, 2,2);
           gridPane.add(submit_btn, 1,3);
           
        announcementsStage.setTitle("ANNOUNCEMENTS PAGE");
        ...
        announcementsStage.show();
         ...
         public void handle(MouseEvent event) {
             ...
             String password = anct_txt.getText();
