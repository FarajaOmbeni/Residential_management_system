...
public void start(Stage adminStage) {
         ...
         Text heading1 = new Text("REGISTER OWNER:");
        heading1.setFill(Color.BLACK);
        heading1.setFont(Font.font("verdana", FontWeight.BOLD, FontPosture.REGULAR, 15));
        
        Text heading2 = new Text("REGISTER TENANT:");
        heading2.setFill(Color.BLACK);
        heading2.setFont(Font.font("verdana", FontWeight.BOLD, FontPosture.REGULAR, 15));
       
        Text heading3 = new Text("ADD ANNOUNCEMENTS:");
        heading3.setFill(Color.BLACK);
        heading3.setFont(Font.font("verdana", FontWeight.BOLD, FontPosture.REGULAR, 15));
  
        Button register_btn2 = new Button("Register Owner");
        register_btn2.setStyle("-fx-background-color: SILVER; -fx-border-color: brown;  -fx-text-fill: black; -fx-border-radius: 5;");
        register_btn2.setCursor(Cursor.HAND);
        Button register_btn1 = new Button("Register Tenant");
        register_btn1.setStyle("-fx-background-color: SILVER; -fx-border-color: brown;  -fx-text-fill: black; -fx-border-radius: 5;");
        register_btn1.setCursor(Cursor.HAND);
        Button add_btn = new Button("Announcements");
        ...
        gridPane.add(register_btn2,2, 1);
        gridPane.add(register_btn1,2, 4);
        gridPane.add(add_btn,2,7);
        
            register_btn2.setOnMouseClicked((new EventHandler<MouseEvent>(){
            ...
            register_btn1.setOnMouseClicked((new EventHandler<MouseEvent>(){
                public void handle(MouseEvent event){
